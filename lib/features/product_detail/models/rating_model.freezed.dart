...
abstract class $RatingCopyWith<$Res> {
  ...
  @useResult
  $Res call({double rating, String userId});
}
...
class _$_Rating implements _Rating {
  const _$_Rating({required this.rating, required this.userId});
  ...
  @override
  String toString() {
    return 'Rating(rating: $rating, userId: $userId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, rating, userId);
...
abstract class _Rating implements Rating {
  const factory _Rating(
      {required final double rating, required final String userId}) = _$_Rating;
